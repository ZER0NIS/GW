...
public:
 ...
 return ATTACK_STAFF;
	...
	//数据处理
	static void DealWith_Select_RoleAttribute(rade_db::PSQL_RESULT result);
	static void DealWith_Select_KitBag(rade_db::PSQL_RESULT result);
	static void DealWith_Select_ActiveSkill(rade_db::PSQL_RESULT result);
	static void DealWith_Select_PassiveSkill(rade_db::PSQL_RESULT result);
	static void DealWith_Select_Altar(rade_db::PSQL_RESULT result);
	static void DealWith_Select_Relation(rade_db::PSQL_RESULT result);
	static void DealWith_Select_RoleBaseInfo(rade_db::PSQL_RESULT result);
	static void DealWith_Select_CanRoleAdd(rade_db::PSQL_RESULT result);
	static void DealWith_Select_CanConsortiaAdd(rade_db::PSQL_RESULT result);
	static void DealWith_Select_Quest(rade_db::PSQL_RESULT result);
	...
	//结果处理
	static void DealWith_Update_RoleAttribute(rade_db::PSQL_RESULT result);
	static void DealWith_Update_KitBag(rade_db::PSQL_RESULT result);
	static void DealWith_Update_ActiveSkill(rade_db::PSQL_RESULT result);
	static void DealWith_Update_PassiveSkill(rade_db::PSQL_RESULT result);
	static void DealWith_Update_Relation(rade_db::PSQL_RESULT result);
	static void DealWith_Update_RoleDel(rade_db::PSQL_RESULT result);
	static void DealWith_Update_RoleUpate(rade_db::PSQL_RESULT result);
	static void DealWith_Update_Friend(rade_db::PSQL_RESULT result);
	static void DealWith_Update_BlackList(rade_db::PSQL_RESULT result);
	static void DealWith_Update_Consortia(rade_db::PSQL_RESULT result);
	static void DealWith_Offline_Update_Uinon(rade_db::PSQL_RESULT result);
	static void DealWith_Update_Quest(rade_db::PSQL_RESULT result);
